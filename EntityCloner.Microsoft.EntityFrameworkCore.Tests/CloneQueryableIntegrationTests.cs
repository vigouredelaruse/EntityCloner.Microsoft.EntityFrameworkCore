...
namespace EntityCloner.Microsoft.EntityFrameworkCore.Tests
{
    ...
    public class CloneQueryableIntegrationTests : DbContextTestBase
    {
                        ...
                        OrderLines = new List<OrderLine>
                        {
                            new OrderLine
                            {
                                ...
                                Article = new Article
                                {
                                    ...
                                    TranslationServices = new HashSet<TranslationService>
                                    {
                                        new TranslationService
                                        {
                                            ServiceName = "Alpha Translation Service"
                                        },
                                        new TranslationService
                                        {
                                            ServiceName = "Beta Translation Service"
                                        }
                                    }
                                },
                            },
                            new OrderLine
                            {
                                ...
                                Article = new Article
                                {
                                    ...
                                    TranslationServices = new HashSet<TranslationService>
                                    {
                                        new TranslationService
                                        {
                                            ServiceName = "Charlie Translation Service"
                                        },
                                        new TranslationService
                                        {
                                            ServiceName = "Delta Translation Service"
                                        }
                                    }
                                }
                            }
        ...
        [Fact]
        public async Task Customer_IncludeEntityWithAllPossibleIncludesAndManyToMany()
        {
            // Act
            var queryable = TestDbContext.Set<Customer>()
                .Include(c => c.Orders)
                ...
                .ThenInclude(c => c.OrderLines)
                .ThenInclude(c => c.Article)
                .ThenInclude(c => c.TranslationServices)
